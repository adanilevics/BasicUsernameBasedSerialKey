...
user_input_name = input("Enter your serial key :")
...
if search_str(database_path, user_input_name) == True:
    user_input_serial_check = hashlib.md5(user_name.encode('utf-8')).hexdigest()
